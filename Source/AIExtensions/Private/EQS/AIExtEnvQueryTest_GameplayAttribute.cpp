...
void UAIExtEnvQueryTest_GameplayAttribute::RunTest( FEnvQueryInstance & query_instance ) const
{
...
FText UAIExtEnvQueryTest_GameplayAttribute::GetDescriptionDetails() const
{
    return FText::FromString( Attribute.GetName() );
}

FText UAIExtEnvQueryTest_GameplayAttribute::GetDescriptionTitle() const
{
