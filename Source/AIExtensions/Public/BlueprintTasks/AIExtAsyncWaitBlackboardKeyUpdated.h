...
UCLASS()
class AIEXTENSIONS_API UAIExtAsyncWaitBlackboardKeyUpdated final : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()

public:
    UFUNCTION( BlueprintCallable, meta = ( BlueprintInternalUseOnly = "true", Category = "AI", WorldContext = "WorldContextObject" ) )
    static UAIExtAsyncWaitBlackboardKeyUpdated * WaitBBKeyUpdated( UBlackboardComponent * blackboard_component, FName key_name, bool only_trigger_once = false );
