...
UCLASS()
class AIEXTENSIONS_API UAIExtEnvQueryTest_GameplayAttribute final : public UEnvQueryTest
{
    GENERATED_BODY()

public:
    explicit UAIExtEnvQueryTest_GameplayAttribute( const FObjectInitializer & object_initializer );
